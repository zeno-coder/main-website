...
window.addEventListener("scroll", () => {
  ...
  const back = document.querySelector(".cave-back");
  const mid = document.querySelector(".cave-mid");
  const front = document.querySelector(".cave-front");

  back.style.transform =
    `translateZ(-200px) translateY(${scrollY * 0.1}px) scale(1.3)`;

  mid.style.transform =
    `translateZ(-100px) translateY(${scrollY * 0.2}px) scale(1.1)`;

  front.style.transform =
    `translateZ(50px) translateY(${scrollY * 0.3}px)`;
});


/* ============================= */
/* CHAMBER REVEAL ANIMATION */
/* ============================= */

const chambers = document.querySelectorAll(".section-chamber");
